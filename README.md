...
Git-backed Supabase provider overlays for [`hhaus`](https://supabase.com/dashboard/org/zbkkhhovcgpjgfhttaii), mapped to [`hacker-house-medellin`](https://github.com/hacker-house-medellin).

The Supabase organization short name `hhaus` maps to GitHub organization `hacker-house-medellin`; the mapping is explicit because name equality does not hold.

## Project inventory

| Project ref | Local slug | Canonical | Provider status | Git working directory | Integration |
|---|---|---:|---|---|---|
| `bihpugkzayenywfyajnr` | `hhaus-project` | yes | active | `projects/bihpugkzayenywfyajnr` | planned |
